        ...
        <div class="row">
          ...
          <br>
            <div class="card card-info">
              ...
              <form action="{{route('resources.update',$resource->id)}}" method="post" enctype="multipart/form-data">@csrf
                @method('put')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="title" value="{{$resource->title}}" @error('title')
                        is-invalid
                    @enderror>
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      @enderror>{{$resource->description}}</textarea>
